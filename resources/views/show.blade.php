...
@if (Auth::check())
   ...
   <div class="alert alert-success alert-dismissible" style="width:300px; margin-left:500px; margin-top:20px; text-align:center;">
    <a  class="close" data-dismiss="alert" aria-label="close">&times;</a>
    <strong>Welcome Back !</strong> 
  </div>

  <a href="{{url('/create')}}" class="btn btn-dark" style="margin-left:540px; margin-top:30px;">Nouveau film ? Cliquez-ici !</a>
...
<footer style="position:fixed;bottom:0; margin-bottom:-10px;width:100%; margin-left:600px;">
 <div class="row">
